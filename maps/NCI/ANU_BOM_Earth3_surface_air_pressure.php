<?php
 ...
 $nonce = page_top("BOM Earth3 Projected. Hourly Surface Air Pressure", "no");
?>
...
import { pressure_Pa_stops }
 from '../../common/map_styles.js'

// Primary Map metadata
const gMAP_METADATA = {
 "latest_endpoint": "https://thredds.nci.org.au/thredds/catalog/py18/BARPA/output/CMIP6/DD/AUS-15/BOM/EC-Earth3/ssp585/r1i1p1f1/BARPA-R/v1-r1/1hr/ps/latest/catalog.xml",
 "subsetting_endpoint_prefix": 
  "https://thredds.nci.org.au/thredds/ncss/grid/py18/BARPA/output/CMIP6/DD/AUS-15/BOM/EC-Earth3/ssp585/r1i1p1f1/BARPA-R/v1-r1/1hr/ps/latest/",
 "subsetting_query_string_suffix": 
  "&addLatLon=true&accept=netcdf&format=netcdf3",
 "variable": 'ps',
 "map_title": 
  "BOM Earth3 Projected. Hourly Surface Air Pressure",
 "author_comment": 
  "Select a Date. Click to view Surface Air Pressure.",
 "catalog_filter_string":
  "ps_AUS-15_EC-Earth3_ssp585_r1i1p1f1_BOM_BARPA-R_v1-r1_1hr_",
 "related_links": 
  [{"label": "THREDDS Endpoint",
    "href": "https://thredds.nci.org.au/thredds/catalog/py18/BARPA/output/CMIP6/DD/AUS-15/BOM/EC-Earth3/ssp585/r1i1p1f1/BARPA-R/v1-r1/1hr/ps/latest/catalog.html"}],
 "map_attribution": 'Data &copy; ANU',
 "map_type": 'grid',
 "layer_starting_opacity": 0.6,
 "cell_color_stops": pressure_Pa_stops,
