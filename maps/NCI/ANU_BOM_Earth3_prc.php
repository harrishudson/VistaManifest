<?php
 ...
 $nonce = page_top("BOM Earth3 Projected. Hourly Convective Precipitation", "no");
?>
...
const gMAP_METADATA = {
 "latest_endpoint": "https://thredds.nci.org.au/thredds/catalog/py18/BARPA/output/CMIP6/DD/AUS-15/BOM/EC-Earth3/ssp585/r1i1p1f1/BARPA-R/v1-r1/1hr/prc/latest/catalog.xml",
 "subsetting_endpoint_prefix": 
  "https://thredds.nci.org.au/thredds/ncss/grid/py18/BARPA/output/CMIP6/DD/AUS-15/BOM/EC-Earth3/ssp585/r1i1p1f1/BARPA-R/v1-r1/1hr/prc/latest/",
 "subsetting_query_string_suffix": 
  "&addLatLon=true&accept=netcdf&format=netcdf3",
 "variable": 'prc',
 "map_title": 
  "BOM Earth3 Projected. Hourly Convective Precipitation",
 "author_comment": 
  "Select a Date. Click to view Convective Precipitation.",
 "catalog_filter_string":
  "prc_AUS-15_EC-Earth3_ssp585_r1i1p1f1_BOM_BARPA-R_v1-r1_1hr_",
 "related_links": 
  [{"label": "THREDDS Endpoint",
    "href": "https://thredds.nci.org.au/thredds/catalog/py18/BARPA/output/CMIP6/DD/AUS-15/BOM/EC-Earth3/ssp585/r1i1p1f1/BARPA-R/v1-r1/1hr/prc/latest/catalog.html"}],
