<?php
 ...
 $nonce = page_top('cpc_global_precip Daily total of precipitation', 'no');
?>
...
const gMAP_METADATA = {
 ...
 "map_title":
  'cpc_global_precip Daily Precipitation',
 "map_attribution":
  'Data PSL NOAA',
