<?php
 ...
 $nonce = page_top('cpc_global_temp Daily Minimum Temperature', 'yes');
?>
...
const gMAP_METADATA = {
 ...
 "variable": "tmin",
 "author_comment": 
  "Select a day to display Daily Minimum Temperature.",
 "related_links": 
...
<div class="indent">
 <h4>Dataset: cpc_global_temp. Daily Minimum Temperature.</h4>
 <p>
  <dl>
   <dt>Select Day</dt>
