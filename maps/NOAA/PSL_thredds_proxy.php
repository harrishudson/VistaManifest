<?php
 ...
 $GLOBALS['CATALOG_PREFIX'] = "https://psl.noaa.gov/thredds";
 $GLOBALS['ALLOWED_DOMAINS'] = ["psl.noaa.gov"];
 $GLOBALS['ALLOWED_SCHEMES'] = ["https"];
 $GLOBALS['CACHE_LOCATION'] = "./cache";
 $GLOBALS['CACHE_TIMEOUT'] = 30;
 $GLOBALS['CACHE_FILENAME_SUFFIX'] = "PSL";  // Suffix must not have any spaces
