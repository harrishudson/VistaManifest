<?php
 ...
 $nonce = page_top('cpc_global_temp Daily Maximum Temperature', 'yes');
?>
...
const gMAP_METADATA = {
 ...
 "catalog_endpoint": 
  "/catalog/Datasets/cpc_global_temp/catalog.xml",
 "subsetting_endpoint_prefix": 
  "/ncss/grid/Datasets/cpc_global_temp",
 "subsetting_query_string_suffix": 
  "&addLatLon=true&accept=netcdf&format=netcdf3",
 "variable": "tmax",
 "author_comment": 
  "Select a day to display Daily Maximum Temperature.",
 "related_links": 
  [{"label":"THREDDS Endpoint",
    "href":"https://psl.noaa.gov/thredds/catalog/Datasets/cpc_global_temp/catalog.html"}],
...
<div class="indent">
 <h4>Dataset: cpc_global_temp. Daily Maximum Temperature.</h4>
 <p>
  <dl>
   <dt>Select Day</dt>
