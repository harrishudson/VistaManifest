<?php
 ...
 $GLOBALS['CATALOG_PREFIX'] = "https://coastwatch.noaa.gov/thredds";
 $GLOBALS['ALLOWED_DOMAINS'] = ["coastwatch.noaa.gov"];
 $GLOBALS['ALLOWED_SCHEMES'] = ["https"];
 $GLOBALS['CACHE_LOCATION'] = "./cache";
 $GLOBALS['CACHE_TIMEOUT'] = 30;
 $GLOBALS['CACHE_FILENAME_SUFFIX'] = "COASTWATCH";  // Suffix must not have any spaces
