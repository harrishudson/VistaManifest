<?php
 ...
 $nonce = page_top("PacIOOS Nearest Coastline (Land)", "no");
?>
...
import { shoreline_distance_stops } 
 from '../../common/map_styles.js'

// Primary Map metadata
const gMAP_METADATA = {
 "latest_endpoint": "https://pae-paha.pacioos.hawaii.edu/thredds/ncss/dist2coast_1deg/dataset.xml",
 "subsetting_endpoint_prefix": 
  "https://pae-paha.pacioos.hawaii.edu/thredds/ncss/dist2coast_1deg",
 "subsetting_query_string_suffix": 
  "&disableLLSubset=on&disableProjSubset=on&addLatLon=true&accept=netcdf&format=netcdf",
 "variable": 'dist',
 "map_title": "PacIOOS 0.1deg Nearest Coastline (Land)",
 "author_comment": "Click/tap to display distance in kilometers",
 "catalog_filter_string": "",
 "related_links": 
  [{"label": "THREDDS Endpoint",
    "href": "https://pae-paha.pacioos.hawaii.edu/thredds/dist2coast.html?dataset=dist2coast_1deg"
   }],
 "map_attribution": 'Data &copy; PacIOOS',
 "map_type": 'grid',
 "layer_starting_opacity": 0.65,
 "cell_color_stops": shoreline_distance_stops,
...
function fillCell(cellData) {
 return cfu.steppedHexColor(Math.abs(cellData.value), gMAP_METADATA['cell_color_stops'])
}
...
function redraw_map_layer() {
 ...
 // Fetch this at slightly higher resolution
...
async function render_image() {
 ...
 let img1 = await CFR.draw2DbasicGrid('dist', 
	                       {},
	                       SphericalProjection, 
	                       'image',
	                        {"fill": fillCell,
