<?php
 ...
 $GLOBALS['CATALOG_PREFIX'] = "https://pae-paha.pacioos.hawaii.edu/thredds/";
 $GLOBALS['ALLOWED_DOMAINS'] = ["pae-paha.pacioos.hawaii.edu"];
 $GLOBALS['ALLOWED_SCHEMES'] = ["https"];
 $GLOBALS['CACHE_LOCATION'] = "./cache";
 $GLOBALS['CACHE_TIMEOUT'] = 360;
 $GLOBALS['CACHE_FILENAME_SUFFIX'] = "PACIOOS";  // Suffix must not have any spaces
