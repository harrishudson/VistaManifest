<?php
 ...
 $nonce = page_top("Forecast Wind - Timeseries", "no");
?>
...
const gMAP_METADATA = {
 ...
 "map_title": 
  "Forecast Wind - Timeseries",
 "author_comment": 
  "Click to Arrows to View average wind data.  Click Map to show wind Magnitude.",
 "related_links": 
...
function redraw_map_layer() {
 ...
 var query_string = `?var=${gMAP_METADATA['variable']}&var=Wind_direction_from_which_blowing_height_above_ground`
 ...
 // Large Animated visualizations may need to cap/limit the image resolution
 // or reponses may become vary large on large screens.
 var image_size = {x: img_x_range, y: img_y_range}
 if (img_x_range + img_y_range > 1100)
  image_size = {x: 550, y: 550}
 let HorizStride = gNETCDF_TDS.getHorizStride(image_size, queryBounds, 8)
