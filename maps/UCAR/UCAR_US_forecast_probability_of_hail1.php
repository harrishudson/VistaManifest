<?php
 ...
 $nonce = page_top("Probability Hail Probability (24_Hour Average) above_0 % @ Ground or water surface", "no");
?>
...
import { risk_percentage_stops } 
 from '../../common/map_styles.js'

// Primary Map metadata
const gMAP_METADATA = {
 "proxy": "UCAR_thredds_proxy.php?url=",
 "latest_endpoint": "/catalog/grib/NCEP/NDFD/SPC/CONUS/latest.xml",
 "subsetting_endpoint_prefix": "/ncss/grid/grib/NCEP/NDFD/SPC/CONUS/",
 "subsetting_query_string_suffix": 
  "&addLatLon=true&accept=netcdf&format=netcdf3",
 "variable": 'Hail_Probability_surface_24_Hour_Average_probability_above_0',
 "map_title": 
  "Probability Hail Probability (24_Hour Average) above_0 % @ Ground or water surface",
 "author_comment": 
  "Click to view Probability of Hail Value.",
 "related_links": 
  [{"label": "THREDDS Endpoint",
    "href": "https://thredds.ucar.edu/thredds/catalog/grib/NCEP/NDFD/SPC/CONUS/catalog.html"}],
 "map_attribution": 'Data &copy; UCAR',
 "map_type": 'grid',
 "layer_starting_opacity": 0.85,
 "cell_color_stops":  risk_percentage_stops,
...
async function map_tap(evt) {
 ...
 let DimensionFilter = {}
 DimensionFilter[timeVariable] = timeValue
