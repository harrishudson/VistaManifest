<?php
 ...
 $nonce = page_top("Total Cloud Cover @ Ground or water surface", "no");
?>
...
const gMAP_METADATA = {
 ...
 "variable": 'Total_cloud_cover_surface',
 "map_title": 
  "Total Cloud Cover @ Ground or water surface",
 "author_comment": 
  "Click to view Cloud Cover Percentage.",
 "related_links": 
 ...
 "idealCellSize": 4 // Modify accordingly to play with resolution.  Default 4 pixels per cell.
}
