<?php
 ...
 $GLOBALS['CATALOG_PREFIX'] = "https://thredds.ucar.edu/thredds/";
 $GLOBALS['ALLOWED_DOMAINS'] = ["thredds.ucar.edu"];
 $GLOBALS['ALLOWED_SCHEMES'] = ["https"];
 $GLOBALS['CACHE_LOCATION'] = "./cache";
 $GLOBALS['CACHE_TIMEOUT'] = 30;
 $GLOBALS['CACHE_FILENAME_SUFFIX'] = "UCAR";  // Suffix must not have any spaces
