<?php
 ...
 $nonce = page_top("Total Precipitation (6_Hour Accumulation) @ Ground or water surface", "no");
?>
...
const gMAP_METADATA = {
 ...
 "map_title": 
  "Total Precipitation (6_Hour Accumulation) @ Ground or water surface",
 "author_comment": 
  "Click to view Total Precipitation.",
 "related_links": 
