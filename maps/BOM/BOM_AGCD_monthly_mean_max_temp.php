<?php
 ...
 $nonce = page_top("BOM Historical Monthly Maximum (mean) Air Temperature", "no");
?>
...
const gMAP_METADATA = {
 ...
 "catalog_endpoint": "/catalog/agcd/tmax/mean/r005/01month/",
 "subsetting_endpoint_prefix": "/ncss/grid/agcd/tmax/mean/r005/01month/",
 "subsetting_query_string_suffix": "&addLatLon=true&accept=netcdf&format=netcdf3",
 "variable": 'tmax',
 "map_title": 'BOM Historical Monthly Maximum (mean) Air Temperature',
 "map_attribution": 'BOM',
 "map_type": 'grid',
 "author_comment": 
  "Select a Month to view Monthly Maximum Temperature.",
 "related_links": 
  [{"label": "THREDDS Endpoint",
    "href": "http://opendap.bom.gov.au/thredds/catalog/agcd/tmax/mean/r005/01month/catalog.html"}],
