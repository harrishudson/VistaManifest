<?php
 ...
 $nonce = page_top("BOM Historical Daily Precipitation Totals", "no");
?>
...
const gMAP_METADATA = {
 ...
 "catalog_endpoint": "/catalog/agcd/precip/total/r005/01day/",
 "subsetting_endpoint_prefix": "/ncss/grid/agcd/precip/total/r005/01day/",
 "subsetting_query_string_suffix": "&addLatLon=true&accept=netcdf&format=netcdf3",
 "variable": 'precip',
 "map_title": 'BOM Historical Daily Precipitation Totals',
 "map_attribution": 'BOM',
 "map_type": 'grid',
 "author_comment": 
 ...
 "related_links": 
  [{"label": "THREDDS Endpoint",
    "href": "http://opendap.bom.gov.au/thredds/catalog/agcd/precip/total/r005/01day/catalog.html"}],
...
function fetch_date_metadata() {
 ...
 let endpoint = 
  ...
  yy+
  '/'+
  `precip_total_r005_${yy}${mm}${dd}_${yy}${mm}${dd}`+
  '.nc'
