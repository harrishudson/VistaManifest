<?php
 ...
 $nonce = page_top("BOM Historical Daily Minimum (mean) Air Temperature", "no");
?>
...
const gMAP_METADATA = {
 ...
 "catalog_endpoint": "/catalog/agcd/tmin/mean/r005/01day/",
 "subsetting_endpoint_prefix": "/ncss/grid/agcd/tmin/mean/r005/01day/",
 "subsetting_query_string_suffix": "&addLatLon=true&accept=netcdf&format=netcdf3",
 "variable": 'tmin',
 "map_title": 'BOM Historical Daily Minimum (mean) Air Temperature',
 "map_attribution": 'BOM',
 "map_type": 'grid',
 "author_comment": 
  "Select a Day to view Daily Minimum Temperature.",
 "related_links": 
  [{"label": "THREDDS Endpoint",
    "href": "http://opendap.bom.gov.au/thredds/catalog/agcd/tmin/mean/r005/01day/catalog.html"}],
...
function fetch_date_metadata() {
 ...
 let endpoint = 
  ...
  yy+
  '/'+
  `tmin_mean_r005_${yy}${mm}${dd}_${yy}${mm}${dd}`+
  '.nc'
